        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg transform hover:scale-105 transition duration-300">
            ...
            <h4 className="text-xl font-semibold text-gray-700 mb-2">
              1. Registre a Denúncia
            </h4>
            <p className="text-gray-600">
              Descreva o problema em detalhes, anexando fotos ou vídeos se
              possível.
            </p>
          </div>
          <div className="p-6 bg-white rounded-xl shadow-lg transform hover:scale-105 transition duration-300">
            ...
            <p className="text-gray-600">
              Receba atualizações sobre o andamento da sua denúncia, de forma
              transparente.
            </p>
          </div>
          <div className="p-6 bg-white rounded-xl shadow-lg transform hover:scale-105 transition duration-300">
            ...
            <p className="text-gray-600">
              Contribua para a melhoria da qualidade de ensino e da comunidade
              escolar.
            </p>
          </div>
        </div>
